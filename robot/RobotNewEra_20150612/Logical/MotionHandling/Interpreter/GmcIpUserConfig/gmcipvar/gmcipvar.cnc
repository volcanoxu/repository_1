...
<!--****************************************************************************
    ...
    *     </VAR>
    ****************************************************************************-->
	<PV Alias="JogSpeed" Type="REAL">Jog:Jogging.Speed</PV>
	<PV Alias="JogMode" Type="USINT">Jog:Jogging.Mode</PV>
	<PV Alias="JogStep" Type="BOOL" Synch="path_synch">Jog:Jogging.Step</PV>
	<PV Alias="MoveAxis" Type="SINT" AryDim1="6">Jog:Jogging.MoveAxis</PV>
	<PV Alias="JogRun" Type="BOOL" Synch="path_synch">Jog:Jogging.Run</PV>
	<PV Alias="JogLimit" Type="BOOL" Synch="path_syn ch">Jog:Jogging.Run</PV>
