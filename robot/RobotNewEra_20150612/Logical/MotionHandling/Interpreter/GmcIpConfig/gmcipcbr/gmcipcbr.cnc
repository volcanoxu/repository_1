...
<Root LangModule="ailgcode" Version="1.0">
  ...
  <Types>
    ...
    <ZeroPointTableIndex type="INT" MinValue="0" MaxValue="199" />
   ...
   <G251 GNum="251" Group="250" AllowGroups="250">
    ...
    <G320.2 GNum="320.2" Alias="WS_CTRL_ON" Group="212" MinArgs="0" MaxArgs="3" >
      ...
      if(Defined(:${excl_off}:))
        ...
        #next_motion.Data.UI4_value = #next_motion.Data.UI4_value + 10;
      endif
      if(Defined(:${cyclic_on}:))
        #next_motion.Data.UI4_value = #next_motion.Data.UI4_value + 100;
      endif
      PushPacket(::);
      </G320.2>
