...
*****************************************************************************
*                                                                           *
*            Header File for Library ARNC0man (Version 2481)                *
*                                                                           *
**************************** COPYRIGHT (C) **********************************
...
#define ARNC0MAN_H_VERSION 0x2481
...
typedef struct ARNC0NCMST_typ {               /* Status CNC movement */
   UINT               cnt_ncprog;             /* Number of started NC programs/blocks */
...
typedef struct ARNC0NCPRG_typ {               /* CNC program */
   ...
   UDINT              offset_ncprog;          /* Offset (Byte) in current NC program */
   REAL               s_ncprog;               /* Path position in current NC program */
...
typedef struct ARNC0NCDEC_typ {               /* CNC decoder */
   ...
   ARNC0DCBRK_typ     breakpoint;             /* Breakpoints in NC program */
...
typedef struct ARNC0NCAXP_typ {               /* CNC-axis settings */
   ...
   UDINT              nc_object;              /* NC object or ncOFF */
   UDINT              nc_object_plcopen;      /* NC object or ncOFF */
   USINT              name[14];               /* Name of the axis in the NC programm */
...
typedef struct ARNC0NCMON_typ {               /* CNC monitor */
   ...
   UDINT              nr_ncprog;              /* Number of current NC program */
   USINT              name_ncprog[100];       /* Name of current CNC program */
   UDINT              pos_ncprog;             /* Position in current NC program */
   UDINT              block_ncprog;           /* Block number in CNC program */
   UDINT              line_ncprog;            /* Line number in CNC program */
   USINT              call_level;             /* Current call level for sub-programs */
   USINT              reserve1[3];            /* Reserved */
   REAL               t_ncprog;               /* Run-Time of current NC program */
   REAL               s_ncprog;               /* Path position in current NC program */
   REAL               v_ncprog;               /* Path speed currently defined in NC program */
...
typedef struct ARNC0CNC_typ {                 /* ARNC0 - CNC-System */
   ...
   ARNC0NCRST_typ     restart;                /* RESTART of a CNC-Programm */
