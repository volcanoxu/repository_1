...
FUNCTION_BLOCK DiagCreateInfo			(*collects information about the currently configured and/or inserted hardware modules; asynchronous execution*)
	VAR_INPUT
...
FUNCTION_BLOCK DiagDisposeInfo			(*frees up the resources taken up by DiagCreateInfo(); asynchronous execution*)
	VAR_INPUT
		enable       : BOOL; 			(*enables execution*)
...
FUNCTION_BLOCK DiagGetNumInfo			(*queries the numeric value of a specified information entry*)
	VAR_INPUT
		enable       : BOOL; 			(*enables execution*)
...
FUNCTION_BLOCK DiagGetStrInfo			(*queries the string value of a specified information entry*)
	VAR_INPUT
		enable       : BOOL; 			(*enables execution*)
        ident        : UDINT;			(*identifier returned from DiagCreateInfo()*)
        index        : UDINT;			(*index of the entry [0..nrEntries-1]*)
