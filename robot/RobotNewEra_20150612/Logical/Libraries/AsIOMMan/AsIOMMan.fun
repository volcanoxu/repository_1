 ...
 * Author: B+R
 ********************************************************************
 * Functions and function blocks of library AsIOMMan
 ********************************************************************)
                                                                      
FUNCTION_BLOCK AsIOMMCreate				(*creates a mapping- or ArConfigmodule from the pDataobject data object; asynchronous execution*)
	VAR_INPUT
...
FUNCTION_BLOCK AsIOMMRemove				(*deinstalls and deletes the pModuleName CM module; asynchronous execution*)
	VAR_INPUT
		enable	:BOOL;					(*enables execution*)
...
FUNCTION_BLOCK AsIOMMCopy				(*creates a copy of the pModuleName CM module in the form of a data object; asynchronous execution*)
	VAR_INPUT
		enable	:BOOL;					(*enables execution*)
		pModuleName	:UDINT;				(*module name of the configuration- or mappingmodule given as a pointer*)
		pNewModule	:UDINT;				(*new module name of the mapping- or ArConfigmodules given as a pointer*)
