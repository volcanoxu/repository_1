...
$(AS_CPU_PATH)/VcFntDat/arialbd.ccf:$(AS_CPU_PATH)/VcFntDat/arialbd.vco
	 $(LINK) "$^" -o "$@" -warningLevel2 -m arialbd.ttf -name Visu -profile "False" -vcr 4211 -sfas
...
$(AS_CPU_PATH)/VcFntDat/arial.ccf:$(AS_CPU_PATH)/VcFntDat/arial.vco
	 $(LINK) "$^" -o "$@" -warningLevel2 -m arial.ttf -name Visu -profile "False" -vcr 4211 -sfas
...
$(AS_CPU_PATH)/VcFntDat/simsun.ccf:$(AS_CPU_PATH)/VcFntDat/simsun.vco
	 $(LINK) "$^" -o "$@" -warningLevel2 -m simsun.ttf -name Visu -profile "False" -vcr 4211 -sfas
...
$(AS_CPU_PATH)/VcFntDat/courbd.ccf:$(AS_CPU_PATH)/VcFntDat/courbd.vco
	 $(LINK) "$^" -o "$@" -warningLevel2 -m courbd.ttf -name Visu -profile "False" -vcr 4211 -sfas
...
$(AS_CPU_PATH)/VcFntDat/dejavz0z.ccf:$(AS_CPU_PATH)/VcFntDat/dejavz0z.vco
	 $(LINK) "$^" -o "$@" -warningLevel2 -m dejavz0z.ttf -name Visu -profile "False" -vcr 4211 -sfas
...
$(AS_CPU_PATH)/VcFntDat/arialxsr.ccf:$(AS_CPU_PATH)/VcFntDat/arialxsr.vco
	 $(LINK) "$^" -o "$@" -warningLevel2 -m arialxsr.ttf -name Visu -profile "False" -vcr 4211 -sfas
