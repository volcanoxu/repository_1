...
$(AS_CPU_PATH)/OptMotion/OptMotion.c.o: \
	...
	FORCE 
	@"$(AS_BIN_PATH)/BR.AS.CCompiler.exe" "$(AS_PROJECT_PATH)/Logical/MotionHandling/Optimizer/OptMotion/OptMotion.c" -o "$(AS_CPU_PATH)/OptMotion/OptMotion.c.o"  -T SG4  -M IA32  -B D4.21 -G V4.1.2  -s "MotionHandling.Optimizer.OptMotion" -t "$(AS_TEMP_PATH)" -I "$(AS_PROJECT_PATH)/Logical/MotionHandling/Optimizer/OptMotion" "$(AS_TEMP_PATH)/Includes/MotionHandling/Optimizer/OptMotion"  "$(AS_TEMP_PATH)/Includes/MotionHandling/Optimizer"  "$(AS_TEMP_PATH)/Includes/MotionHandling" "$(AS_TEMP_PATH)/Includes" -trigraphs -fno-asm -D _DEFAULT_INCLUDES -D _SG4 -fPIC -O0 -g -Wall -include "$(AS_CPU_PATH)/Libraries.h" -x c -P "$(AS_PROJECT_PATH)" -secret "$(AS_PROJECT_PATH)_br.as.ccompiler.exe"
