...
ProjectMakeFile:
	...
	@"$(AS_BIN_PATH)/BR.AS.AnalyseProject.exe" "$(AS_PROJECT_PATH)/RobotNewEra.apj" -t "$(AS_TEMP_PATH)" -c "$(AS_CONFIGURATION)" -o "$(AS_BINARIES_PATH)"   -sfas -buildMode "Rebuild" 

	@$(AS_GNU_BIN_PATH)/mingw32-make.exe -r -f 'D:/AS/workspace/projects/RobotNewEra_20150612/Temp/Objects/$(AS_CONFIGURATION)/PLC1/#cpu.mak' -k 
