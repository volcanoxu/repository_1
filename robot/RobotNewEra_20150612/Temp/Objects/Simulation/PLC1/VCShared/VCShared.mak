...
VCUG_SOURCES_Visu=$(AS_PROJECT_PATH)/Logical/VCShared/UnitGroups/Length.vcug \
	...
	$(AS_PROJECT_PATH)/Logical/VCShared/UnitGroups/Percnet.vcug \
	$(AS_PROJECT_PATH)/Logical/VCShared/UnitGroups/Div60.vcug \
	$(AS_PROJECT_PATH)/Logical/VCShared/UnitGroups/Degree.vcug \
	$(AS_PROJECT_PATH)/Logical/VCShared/UnitGroups/Unit.vcug 
...
ALGRP_SOURCES_Visu=$(AS_PROJECT_PATH)/Logical/VCShared/AlarmGroups/SystemAlarms.algrp \
	$(AS_PROJECT_PATH)/Logical/VCShared/AlarmGroups/ApplicationAlarms.algrp \
	$(AS_PROJECT_PATH)/Logical/VCShared/AlarmGroups/WarnMsg.algrp \
	$(AS_PROJECT_PATH)/Logical/VCShared/AlarmGroups/Errors.algrp 
...
DSO_SOURCES_Visu=$(AS_PROJECT_PATH)/Logical/VCShared/DataSources/Internal.dso \
	...
	$(AS_PROJECT_PATH)/Logical/VCShared/DataSources/InternalSource.dso 
...
$(AS_CPU_PATH)/VCShared/vcug.Length.vco: $(AS_PROJECT_PATH)/Logical/VCShared/UnitGroups/Length.vcug
	 $(VCC) -f "$<" -o "$@" -l "$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr" -cv "$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo" -pal "$(PALFILE_Visu)" $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4240 -sfas
...
$(AS_CPU_PATH)/VCShared/vcug.Percnet.vco: $(AS_PROJECT_PATH)/Logical/VCShared/UnitGroups/Percnet.vcug
	 $(VCC) -f "$<" -o "$@" -l "$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr" -cv "$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo" -pal "$(PALFILE_Visu)" $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4240 -sfas


$(AS_CPU_PATH)/VCShared/vcug.Div60.vco: $(AS_PROJECT_PATH)/Logical/VCShared/UnitGroups/Div60.vcug
	 $(VCC) -f "$<" -o "$@" -l "$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr" -cv "$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo" -pal "$(PALFILE_Visu)" $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4240 -sfas
...
$(AS_CPU_PATH)/VCShared/vcug.Unit.vco: $(AS_PROJECT_PATH)/Logical/VCShared/UnitGroups/Unit.vcug
	 $(VCC) -f "$<" -o "$@" -l "$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr" -cv "$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo" -pal "$(PALFILE_Visu)" $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4240 -sfas
...
$(AS_CPU_PATH)/VCShared/algrp.ApplicationAlarms.vco: $(AS_PROJECT_PATH)/Logical/VCShared/AlarmGroups/ApplicationAlarms.algrp
	 $(VCC) -f "$<" -o "$@" -l "$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr" -cv "$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo" -pal "$(PALFILE_Visu)" $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4240 -sfas


$(AS_CPU_PATH)/VCShared/algrp.WarnMsg.vco: $(AS_PROJECT_PATH)/Logical/VCShared/AlarmGroups/WarnMsg.algrp
	 $(VCC) -f "$<" -o "$@" -l "$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr" -cv "$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo" -pal "$(PALFILE_Visu)" $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4240 -sfas


$(AS_CPU_PATH)/VCShared/algrp.Errors.vco: $(AS_PROJECT_PATH)/Logical/VCShared/AlarmGroups/Errors.algrp
	 $(VCC) -f "$<" -o "$@" -l "$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr" -cv "$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo" -pal "$(PALFILE_Visu)" $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4240 -sfas
...
$(AS_CPU_PATH)/VCShared/txtgrp.AlarmState_long.vco: $(AS_PROJECT_PATH)/Logical/VCShared/TextGroups/AlarmState_long.txtgrp $(VC_LANGUAGES_Visu)
	 $(VCC) -f "$<" -o "$@" -l "$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr" -cv "$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo" -pal "$(PALFILE_Visu)" $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4240 -sfas


$(AS_CPU_PATH)/VCShared/txtgrp.AcknowledgeState_long.vco: $(AS_PROJECT_PATH)/Logical/VCShared/TextGroups/AcknowledgeState_long.txtgrp $(VC_LANGUAGES_Visu)
	 $(VCC) -f "$<" -o "$@" -l "$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr" -cv "$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo" -pal "$(PALFILE_Visu)" $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4240 -sfas


$(AS_CPU_PATH)/VCShared/txtgrp.AcknowledgeState_short.vco: $(AS_PROJECT_PATH)/Logical/VCShared/TextGroups/AcknowledgeState_short.txtgrp $(VC_LANGUAGES_Visu)
	 $(VCC) -f "$<" -o "$@" -l "$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr" -cv "$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo" -pal "$(PALFILE_Visu)" $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4240 -sfas


$(AS_CPU_PATH)/VCShared/txtgrp.AlarmState_short.vco: $(AS_PROJECT_PATH)/Logical/VCShared/TextGroups/AlarmState_short.txtgrp $(VC_LANGUAGES_Visu)
	 $(VCC) -f "$<" -o "$@" -l "$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr" -cv "$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo" -pal "$(PALFILE_Visu)" $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4240 -sfas


$(AS_CPU_PATH)/VCShared/txtgrp.BypassState_long.vco: $(AS_PROJECT_PATH)/Logical/VCShared/TextGroups/BypassState_long.txtgrp $(VC_LANGUAGES_Visu)
	 $(VCC) -f "$<" -o "$@" -l "$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr" -cv "$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo" -pal "$(PALFILE_Visu)" $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4240 -sfas


$(AS_CPU_PATH)/VCShared/txtgrp.BypassState_short.vco: $(AS_PROJECT_PATH)/Logical/VCShared/TextGroups/BypassState_short.txtgrp $(VC_LANGUAGES_Visu)
	 $(VCC) -f "$<" -o "$@" -l "$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr" -cv "$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo" -pal "$(PALFILE_Visu)" $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4240 -sfas


$(AS_CPU_PATH)/VCShared/txtgrp.AlarmEvent_long.vco: $(AS_PROJECT_PATH)/Logical/VCShared/TextGroups/AlarmEvent_long.txtgrp $(VC_LANGUAGES_Visu)
	 $(VCC) -f "$<" -o "$@" -l "$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr" -cv "$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo" -pal "$(PALFILE_Visu)" $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4240 -sfas


$(AS_CPU_PATH)/VCShared/txtgrp.AlarmEvent_short.vco: $(AS_PROJECT_PATH)/Logical/VCShared/TextGroups/AlarmEvent_short.txtgrp $(VC_LANGUAGES_Visu)
	 $(VCC) -f "$<" -o "$@" -l "$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr" -cv "$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo" -pal "$(PALFILE_Visu)" $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4240 -sfas
...
$(TEMP_PATH_ROOT_Visu)/Objects/$(AS_CONFIGURATION)/$(AS_TEMP_PLC)/VCShared/dso.Internal.vco: $(AS_PROJECT_PATH)/Logical/VCShared/DataSources/Internal.dso 
	 $(VCC) -f "$<" -o "$@" $(DSOFLAGS) $(VCCFLAGS_Visu) -p Visu -vcr 4240 -sfas
...
$(TEMP_PATH_ROOT_Visu)/Objects/$(AS_CONFIGURATION)/$(AS_TEMP_PLC)/VCShared/dso.InternalSource.vco: $(AS_PROJECT_PATH)/Logical/VCShared/DataSources/InternalSource.dso 
	 $(VCC) -f "$<" -o "$@" $(DSOFLAGS) $(VCCFLAGS_Visu) -p Visu -vcr 4240 -sfas

DPT_OBJECTS = $(TEMP_PATH_ROOT_Visu)/Objects/$(AS_CONFIGURATION)/$(AS_TEMP_PLC)/VCShared/dpt.DataPointList.vco
DSO_OBJECTS_Visu=$(TEMP_PATH_ROOT_Visu)/Objects/$(AS_CONFIGURATION)/$(AS_TEMP_PLC)/VCShared/dso.Internal.vco $(TEMP_PATH_ROOT_Visu)/Objects/$(AS_CONFIGURATION)/$(AS_TEMP_PLC)/VCShared/dso.DataSource.vco $(TEMP_PATH_ROOT_Visu)/Objects/$(AS_CONFIGURATION)/$(AS_TEMP_PLC)/VCShared/dso.InternalSource.vco 
...
$(VCRS_OBJECT) : $(VCRS_SOURCE)
	$(VCC) -f "$<" -o "$@" -ct shared -cv "$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo" -sl  $(VCCFLAGS_Visu) -p Visu -vcr 4240 -sfas
...
$(SHARED_MODULE) : $(SHARED_CCF)
	 $(MODGEN) -so $(VC_STATIC_OPTIONS_Shared) -fw "$(VCFIRMWAREPATH)" -m $(VCSTARTUP) -v V1.11.2 -vc "$(VCOBJECT_Visu)" -f "$<" -o "$@" -d vcgclass -profile "False"
...
$(SHARED_CCF): $(VCRS_OBJECT) $(VCR_OBJECTS_Visu) $(VCUG_OBJECTS_Visu) $(ALGRP_OBJECTS_Visu) $(ALCFG_OBJECTS_Visu) $(DSO_OBJECTS_Visu) $(TXTGRP_SHARED_OBJECTS_Visu) $(CVINFO_OBJECTS_Visu)
	-@CMD /Q /C if exist "$(DEL_SHARED_CCF)" DEL /F /Q "$(DEL_SHARED_CCF)" 2>nul
	 ...
	 $(LINK) "$@.lfl" -o "$@" -lib "$(LIB_SHARED)" -P "$(AS_PROJECT_PATH)" -m "shared resources" -profile "False" -warningLevel2 -name Visu -vcr 4240 -sfas
