...
<SwConfiguration CpuAddress="SL1" xmlns="http://br-automation.co.at/AS/SwConfiguration">
  ...
  <TaskClass Name="Cyclic#2">
    <Task Name="Error" Source="ErrorHandling.Error.prg" Memory="UserROM" Description="              " Language="IEC" Debugging="true" />
    <Task Name="HmiKeyCtrl" Source="HmiHandling.HmiKeyCtrl.HmiKeyCtrl.prg" Memory="UserROM" Language="IEC" Debugging="true" />
  </TaskClass>
  <TaskClass Name="Cyclic#3">
    <Task Name="HmiPrg" Source="HmiHandling.HmiPrg.HmiPrg.prg" Memory="UserROM" Description="                               " Language="ANSIC" Debugging="true" />
  </TaskClass>
  ...
  <TaskClass Name="Cyclic#8">
    ...
    <Task Name="UserStd" Source="UserStd.UserStd.prg" Memory="UserROM" Description="               " Language="ANSIC" Debugging="true" />
    <Task Name="HmiHardKey" Source="HmiHandling.HmiHardKey.HmiHardKeyCtrl.prg" Memory="UserROM" Description="                  " Language="ANSIC" Debugging="true" />
