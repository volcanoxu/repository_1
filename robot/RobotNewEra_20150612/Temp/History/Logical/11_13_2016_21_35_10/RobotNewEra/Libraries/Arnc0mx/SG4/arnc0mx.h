...
unsigned long MXPointToJointEx1(unsigned long AddrTrfData, struct MXPointType* Point, MXJointAxisType Joint, unsigned long TrfType, struct MXToolType* Tool, struct MXFrameType* BaseFrame, double RefJoint[6]);
unsigned long MXPointToJointEx(unsigned long AddrTrfData, struct MXPointType* Point, MXJointAxisType Joint, unsigned long TrfType, struct MXToolType* Tool, struct MXFrameType* BaseFrame, MXJointAxisType RefJoint);
unsigned long MXJointToPointEx1(unsigned long AddrTrfData, MXJointAxisType Joint, struct MXPointType* Point, unsigned long AnglesType, unsigned long TrfType, struct MXToolType* Tool, struct MXFrameType* BaseFrame, double RefPath[6]);
unsigned long MXJointToPointEx(unsigned long AddrTrfData, MXJointAxisType Joint, struct MXPointType* Point, unsigned long AnglesType, unsigned long TrfType, struct MXToolType* Tool, struct MXFrameType* BaseFrame, struct MXPointType* RefPoint);
unsigned long MXCncAxesToPoint(unsigned long AddrTrfData, double Axis[15], struct MXPointType* Point, unsigned long TrfType, unsigned long AnglesType, unsigned short AxisMapCode[15], unsigned short AxisMapIdx[15], unsigned long ActiveAxesCount);
unsigned long MXFromOrient(struct MXOrientationType* Orient, double Matrix[9]);
unsigned long MXToOrient(double Matrix[9], unsigned long Type, struct MXOrientationType* Orient, double RefAngle[3]);
unsigned long MXConvertOrient(struct MXOrientationType* OrientIn, unsigned long Type, struct MXOrientationType* OrientOut, double RefAngle[3]);
unsigned long MXFrameRotX(struct MXFrameType* Frame, double Angle);
unsigned long MXFrameRotY(struct MXFrameType* Frame, double Angle);
unsigned long MXFrameRotZ(struct MXFrameType* Frame, double Angle);
unsigned long MXFrameEuler(struct MXFrameType* Frame, double Phi, double Theta, double Psi);
unsigned long MXFrameRPY(struct MXFrameType* Frame, double Roll, double Pitch, double Yaw);
unsigned long MXFrameTrans(struct MXFrameType* Frame, double DistanceX, double DistanceY, double DistanceZ);
unsigned long MXFrameTransX(struct MXFrameType* Frame, double Distance);
unsigned long MXFrameTransY(struct MXFrameType* Frame, double Distance);
unsigned long MXFrameTransZ(struct MXFrameType* Frame, double Distance);
unsigned long MXFrameApply(struct MXFrameType* Frame1, struct MXFrameType* Frame2);
unsigned long MXFromFrame(struct MXFrameType* Frame, struct MXPointType* PointIn, struct MXPointType* PointOut);
unsigned long MXToFrame(struct MXFrameType* Frame, struct MXPointType* PointIn, struct MXPointType* PointOut);
